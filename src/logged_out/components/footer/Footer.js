...
const socialIcons = [
  ...
  // },
  {
    ...
    label: "Facebook",
    href:
      "https://www.facebook.com/Money-Mentor-Financial-Services-LLP-105832561560342/",
  },
  {
    icon: <InstagramIcon color={"white"} style={{ color: "white" }} />,
    label: "Instagram",
    href: "https://www.instagram.com/moneymentor_fs/",
  },
  {
    icon: (
      <svg
    ...
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/money-mentor-financial-services",
  },
  // {
  //   icon: (
  //     <svg
            ...
            <Box display="flex" flexDirection="column">
              ...
              <ul>
                {[
                  {
                    name: "Dhaval Thakkar",
                    contactNumber: "+91 8866381200",
                  },
                  {
                    name: "Rohit Thakker",
                    contactNumber: "+91 9429017794",
                  },
                  {
                    name: "Parth Thakker",
                    contactNumber: "+91 9016076644",
                  },
              ...
              <div className="row d-flex">
                ...
                <div className={"col-md-10"}>
                  ...
                  >
                    <Typography variant="" className="text-white col-md-9">
                      C-916, Siddhi Vinayak Tower, Nr. Kataria House, Off S.G.
